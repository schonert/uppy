...
this.ifd0Offset: ${this.ifd0Offset}, file.byteLength: ${e3.byteLength}`), e3.tiff && await e3.ensureChunk(this.ifd0Offset, o2(this.options));
  ...
  var Dashboard2 = class extends UIPlugin_default {
    constructor(uppy, _opts) {
      ...
      this.showPanel = (id21) => {
        ...
        this.uppy.emit("dashboard:show-panel", id21);
      };
  ...
  function _connectAssembly2(assembly) {
    ...
    if (this.opts.waitForEncoding) {
      assembly.on("result", (stepName, result) => {
        _classPrivateFieldLooseBase15(this, _onResult)[_onResult](id21, stepName, result);
      });
    }
    if (this.opts.waitForEncoding) {
  ...
  var _handleKeyPress = /* @__PURE__ */ _classPrivateFieldLooseKey18("handleKeyPress");
  var _handleSubmit = /* @__PURE__ */ _classPrivateFieldLooseKey18("handleSubmit");
  var UrlUI = class extends d {
    constructor() {
      ...
      Object.defineProperty(this, _handleKeyPress, {
        ...
        value: (ev) => {
          if (ev.keyCode === 13) {
            _classPrivateFieldLooseBase18(this, _handleSubmit)[_handleSubmit]();
          }
        }
      });
    ...
    render() {
      ...
      return h("div", {
        ...
        onKeyUp: _classPrivateFieldLooseBase18(this, _handleKeyPress)[_handleKeyPress],
        ref: (input) => {
          this.input = input;
        },
        "data-uppy-super-focusable": true
        ...
        type: "button",
        onClick: _classPrivateFieldLooseBase18(this, _handleSubmit)[_handleSubmit]
      }, i18n("import")));
    }
  };
  ...
  var _installedPlugins = /* @__PURE__ */ _classPrivateFieldLooseKey19("installedPlugins");
  var RemoteSources = class extends BasePlugin {
    ...
    install() {
      this.opts.sources.forEach((pluginId) => {
        ...
        _classPrivateFieldLooseBase19(this, _installedPlugins)[_installedPlugins].add(this.uppy.getPlugin(pluginId));
      });
    }
    uninstall() {
      for (const plugin of _classPrivateFieldLooseBase19(this, _installedPlugins)[_installedPlugins]) {
        this.uppy.removePlugin(plugin);
      }
      _classPrivateFieldLooseBase19(this, _installedPlugins)[_installedPlugins].clear();
    }
  };
  ...
  var _enableMirror = /* @__PURE__ */ _classPrivateFieldLooseKey20("enableMirror");
  var Webcam = class extends UIPlugin_default {
    constructor(uppy, opts) {
      ...
      _classPrivateFieldLooseBase20(this, _enableMirror)[_enableMirror] = this.opts.mirror;
      this.install = this.install.bind(this);
    ...
    start(options) {
      ...
      if (this.opts.mirror) {
        _classPrivateFieldLooseBase20(this, _enableMirror)[_enableMirror] = true;
      }
    ...
    stopRecording() {
      ...
      return stopped.then(() => {
        ...
        try {
          ...
          _classPrivateFieldLooseBase20(this, _enableMirror)[_enableMirror] = false;
        } catch (err) {
          if (!err.isRestriction) {
            this.uppy.log(err);
          }
    ...
    render() {
      ...
      return h(
        ...
        _extends6({}, webcamState, {
          ...
          mirror: _classPrivateFieldLooseBase20(this, _enableMirror)[_enableMirror],
          src: this.stream
        })
      );
    }
