...
(() => {
  ...
  var nanoid = function(size) {
    ...
    let i4 = size;
    while (i4--) {
      id19 += urlAlphabet[Math.random() * 64 | 0];
    }
    return id19;
  };
  ...
  function generateFileID(file) {
    ...
    if (typeof file.name === "string") {
      id19 += `-${encodeFilename(file.name.toLowerCase())}`;
    }
    if (file.type !== void 0) {
      id19 += `-${file.type}`;
    }
    if (file.meta && typeof file.meta.relativePath === "string") {
      id19 += `-${encodeFilename(file.meta.relativePath.toLowerCase())}`;
    }
    if (file.data.size !== void 0) {
      id19 += `-${file.data.size}`;
    }
    if (file.data.lastModified !== void 0) {
      id19 += `-${file.data.lastModified}`;
    }
    return id19;
  }
...
Uppy plugins must have unique \`id\` options. See https://uppy.io/docs/plugins/#id.`;
    ...
    getPlugin(id19) {
      for (const plugins of Object.values(_classPrivateFieldLooseBase3(this, _plugins)[_plugins])) {
        const foundPlugin = plugins.find((plugin) => plugin.id === id19);
        if (foundPlugin != null)
          return foundPlugin;
      }
      return void 0;
...
this.ifd0Offset: ${this.ifd0Offset}, file.byteLength: ${e3.byteLength}`), e3.tiff && await e3.ensureChunk(this.ifd0Offset, o2(this.options));
    ...
    constructor(props) {
      ...
      this.renderMetaFields = () => {
        ...
        return metaFields.map((field) => {
          const id19 = `uppy-Dashboard-FileCard-input-${field.id}`;
    ...
    constructor(uppy, _opts) {
      ...
      this.showPanel = (id19) => {
        ...
        const activePickerPanel = targets.filter((target) => {
          return target.type === "acquirer" && target.id === id19;
        })[0];
        this.setPluginState({
          activePickerPanel,
          activeOverlayType: "PickerPanel"
        });
        this.uppy.emit("dashboard:show-panel", id19);
      };
  ...
  var WebStorageUrlStorage = /* @__PURE__ */ function() {
    ...
    _createClass4(WebStorageUrlStorage2, [{
      ...
      key: "addUpload",
      value: function addUpload(fingerprint2, upload) {
        var id19 = Math.round(Math.random() * 1e12);
        var key = "tus::".concat(fingerprint2, "::").concat(id19);
  ...
  var getName = (id19) => {
    return id19.split("-").map((s3) => s3.charAt(0).toUpperCase() + s3.slice(1)).join(" ");
  };
  var Provider = class extends RequestClient {
    ...
    fileUrl(id19) {
      return `${this.hostname}/${this.id}/get/${id19}`;
    }
  ...
  var Socket2 = class extends Emitter {
    ...
    emit(ev) {
      ...
      if ("function" === typeof args[args.length - 1]) {
        const id19 = this.ids++;
        const ack = args.pop();
        this._registerAckCallback(id19, ack);
        packet.id = id19;
      }
  ...
  function lookup2(uri, opts) {
    ...
    const id19 = parsed.id;
    const path = parsed.path;
    const sameNamespace = cache[id19] && path in cache[id19]["nsps"];
    ...
    if (newConnection) {
      ...
      if (!cache[id19]) {
        cache[id19] = new Manager(source, opts);
      }
      io = cache[id19];
    }
  ...
  function dedupe(list) {
    ...
    for (const {
      ...
      const id19 = JSON.stringify(options);
      if (id19 in dedupeMap) {
        dedupeMap[id19].fileIDArrays.push(fileIDs);
      } else {
        dedupeMap[id19] = {
          options,
  ...
  var _getAssemblyOptions = /* @__PURE__ */ _classPrivateFieldLooseKey14("getAssemblyOptions");
  var AssemblyOptions = class {
    ...
    async build() {
      ...
      if (this.files.length > 0) {
        return Promise.all(this.files.map((file) => _classPrivateFieldLooseBase14(this, _getAssemblyOptions)[_getAssemblyOptions](file))).then(dedupe);
      }
  ...
  var _assemblyIDs = /* @__PURE__ */ _classPrivateFieldLooseKey15("assemblyIDs");
  var _reject = /* @__PURE__ */ _classPrivateFieldLooseKey15("reject");
  var _remaining = /* @__PURE__ */ _classPrivateFieldLooseKey15("remaining");
  var _resolve = /* @__PURE__ */ _classPrivateFieldLooseKey15("resolve");
  var _uppy = /* @__PURE__ */ _classPrivateFieldLooseKey15("uppy");
  var _watching = /* @__PURE__ */ _classPrivateFieldLooseKey15("watching");
  var _onAssemblyComplete = /* @__PURE__ */ _classPrivateFieldLooseKey15("onAssemblyComplete");
  var _onAssemblyCancel = /* @__PURE__ */ _classPrivateFieldLooseKey15("onAssemblyCancel");
  var _onAssemblyError = /* @__PURE__ */ _classPrivateFieldLooseKey15("onAssemblyError");
  var _onImportError = /* @__PURE__ */ _classPrivateFieldLooseKey15("onImportError");
  var _checkAllComplete = /* @__PURE__ */ _classPrivateFieldLooseKey15("checkAllComplete");
  var _removeListeners = /* @__PURE__ */ _classPrivateFieldLooseKey15("removeListeners");
  var _addListeners3 = /* @__PURE__ */ _classPrivateFieldLooseKey15("addListeners");
  var TransloaditAssemblyWatcher = class extends import_component_emitter8.default {
    constructor(uppy, assemblyIDs) {
      ...
      Object.defineProperty(this, _onAssemblyComplete, {
        writable: true,
        value: (assembly) => {
          if (!_classPrivateFieldLooseBase15(this, _watching)[_watching](assembly.assembly_id)) {
            return;
          }
          _classPrivateFieldLooseBase15(this, _uppy)[_uppy].log(`[Transloadit] AssemblyWatcher: Got Assembly finish ${assembly.assembly_id}`);
          this.emit("assembly-complete", assembly.assembly_id);
          _classPrivateFieldLooseBase15(this, _checkAllComplete)[_checkAllComplete]();
        }
      });
      ...
      Object.defineProperty(this, _onAssemblyError, {
        ...
        value: (assembly, error) => {
          ...
          _classPrivateFieldLooseBase15(this, _uppy)[_uppy].log(`[Transloadit] AssemblyWatcher: Got Assembly error ${assembly.assembly_id}`);
          _classPrivateFieldLooseBase15(this, _uppy)[_uppy].log(error);
      ...
      Object.defineProperty(this, _onImportError, {
        ...
        value: (assembly, fileID, error) => {
          ...
          _classPrivateFieldLooseBase15(this, _onAssemblyError)[_onAssemblyError](assembly, error);
        }
      });
      _classPrivateFieldLooseBase15(this, _uppy)[_uppy] = uppy;
      _classPrivateFieldLooseBase15(this, _assemblyIDs)[_assemblyIDs] = assemblyIDs;
      _classPrivateFieldLooseBase15(this, _remaining)[_remaining] = assemblyIDs.length;
      this.promise = new Promise((resolve, reject) => {
        _classPrivateFieldLooseBase15(this, _resolve)[_resolve] = resolve;
        _classPrivateFieldLooseBase15(this, _reject)[_reject] = reject;
      });
      _classPrivateFieldLooseBase15(this, _addListeners3)[_addListeners3]();
    }
  };
  function _watching2(id19) {
    return _classPrivateFieldLooseBase15(this, _assemblyIDs)[_assemblyIDs].indexOf(id19) !== -1;
  }
  function _checkAllComplete2() {
    _classPrivateFieldLooseBase15(this, _remaining)[_remaining] -= 1;
    if (_classPrivateFieldLooseBase15(this, _remaining)[_remaining] === 0) {
      _classPrivateFieldLooseBase15(this, _removeListeners)[_removeListeners]();
      _classPrivateFieldLooseBase15(this, _resolve)[_resolve]();
    }
  }
  function _removeListeners2() {
    _classPrivateFieldLooseBase15(this, _uppy)[_uppy].off("transloadit:complete", _classPrivateFieldLooseBase15(this, _onAssemblyComplete)[_onAssemblyComplete]);
    _classPrivateFieldLooseBase15(this, _uppy)[_uppy].off("transloadit:assembly-cancel", _classPrivateFieldLooseBase15(this, _onAssemblyCancel)[_onAssemblyCancel]);
    _classPrivateFieldLooseBase15(this, _uppy)[_uppy].off("transloadit:assembly-error", _classPrivateFieldLooseBase15(this, _onAssemblyError)[_onAssemblyError]);
    _classPrivateFieldLooseBase15(this, _uppy)[_uppy].off("transloadit:import-error", _classPrivateFieldLooseBase15(this, _onImportError)[_onImportError]);
  }
  function _addListeners22() {
    _classPrivateFieldLooseBase15(this, _uppy)[_uppy].on("transloadit:complete", _classPrivateFieldLooseBase15(this, _onAssemblyComplete)[_onAssemblyComplete]);
    _classPrivateFieldLooseBase15(this, _uppy)[_uppy].on("transloadit:assembly-cancel", _classPrivateFieldLooseBase15(this, _onAssemblyCancel)[_onAssemblyCancel]);
    _classPrivateFieldLooseBase15(this, _uppy)[_uppy].on("transloadit:assembly-error", _classPrivateFieldLooseBase15(this, _onAssemblyError)[_onAssemblyError]);
    _classPrivateFieldLooseBase15(this, _uppy)[_uppy].on("transloadit:import-error", _classPrivateFieldLooseBase15(this, _onImportError)[_onImportError]);
  }
  ...
  var _rateLimitedQueue2 = /* @__PURE__ */ _classPrivateFieldLooseKey16("rateLimitedQueue");
  var _getClientVersion = /* @__PURE__ */ _classPrivateFieldLooseKey16("getClientVersion");
  var _attachAssemblyMetadata = /* @__PURE__ */ _classPrivateFieldLooseKey16("attachAssemblyMetadata");
  var _createAssembly = /* @__PURE__ */ _classPrivateFieldLooseKey16("createAssembly");
  var _createAssemblyWatcher = /* @__PURE__ */ _classPrivateFieldLooseKey16("createAssemblyWatcher");
  var _shouldWaitAfterUpload = /* @__PURE__ */ _classPrivateFieldLooseKey16("shouldWaitAfterUpload");
  var _reserveFiles = /* @__PURE__ */ _classPrivateFieldLooseKey16("reserveFiles");
  var _onFileUploadURLAvailable = /* @__PURE__ */ _classPrivateFieldLooseKey16("onFileUploadURLAvailable");
  var _findFile = /* @__PURE__ */ _classPrivateFieldLooseKey16("findFile");
  var _onFileUploadComplete = /* @__PURE__ */ _classPrivateFieldLooseKey16("onFileUploadComplete");
  var _onResult = /* @__PURE__ */ _classPrivateFieldLooseKey16("onResult");
  var _onAssemblyFinished = /* @__PURE__ */ _classPrivateFieldLooseKey16("onAssemblyFinished");
  var _cancelAssembly = /* @__PURE__ */ _classPrivateFieldLooseKey16("cancelAssembly");
  var _onCancelAll = /* @__PURE__ */ _classPrivateFieldLooseKey16("onCancelAll");
  var _getPersistentData = /* @__PURE__ */ _classPrivateFieldLooseKey16("getPersistentData");
  var _onRestored = /* @__PURE__ */ _classPrivateFieldLooseKey16("onRestored");
  var _connectAssembly = /* @__PURE__ */ _classPrivateFieldLooseKey16("connectAssembly");
  var _prepareUpload = /* @__PURE__ */ _classPrivateFieldLooseKey16("prepareUpload");
  var _afterUpload = /* @__PURE__ */ _classPrivateFieldLooseKey16("afterUpload");
  var _closeAssemblyIfExists = /* @__PURE__ */ _classPrivateFieldLooseKey16("closeAssemblyIfExists");
  var _onError3 = /* @__PURE__ */ _classPrivateFieldLooseKey16("onError");
  var _onTusError = /* @__PURE__ */ _classPrivateFieldLooseKey16("onTusError");
  var Transloadit = class extends BasePlugin {
    constructor(uppy, opts) {
      ...
      Object.defineProperty(this, _onCancelAll, {
        ...
        value: async function(_temp) {
          ...
          try {
            ...
            await Promise.all(assemblies.map((assembly) => _classPrivateFieldLooseBase16(_this, _cancelAssembly)[_cancelAssembly](assembly)));
          } catch (err) {
            _this.uppy.log(err);
          }
        }
      ...
      Object.defineProperty(this, _onRestored, {
        ...
        value: (pluginData) => {
          ...
          const restoreState = (assemblies) => {
            const files = {};
            const results = [];
            for (const [id19, status] of Object.entries(assemblies)) {
              status.uploads.forEach((uploadedFile) => {
                const file = _classPrivateFieldLooseBase16(this, _findFile)[_findFile](uploadedFile);
          ...
          const restoreAssemblies = () => {
            ...
            Object.keys(uploadsAssemblies2).forEach((uploadID) => {
              ...
              _classPrivateFieldLooseBase16(this, _createAssemblyWatcher)[_createAssemblyWatcher](assemblyIDs, uploadID);
            });
            const allAssemblyIDs = Object.keys(assemblies);
            allAssemblyIDs.forEach((id19) => {
              const assembly = new Assembly_default(assemblies[id19], _classPrivateFieldLooseBase16(this, _rateLimitedQueue2)[_rateLimitedQueue2]);
              _classPrivateFieldLooseBase16(this, _connectAssembly)[_connectAssembly](assembly);
            });
          };
          const updateAssemblies = () => {
            ...
            return Promise.all(Object.keys(assemblies).map((id19) => {
              return this.activeAssemblies[id19].update();
            }));
          };
      ...
      Object.defineProperty(this, _prepareUpload, {
        ...
        value: (fileIDs, uploadID) => {
          const files = fileIDs.map((id19) => this.uppy.getFile(id19));
          ...
          const createAssembly = async (_ref) => {
            ...
            try {
              const assembly = await _classPrivateFieldLooseBase16(this, _createAssembly)[_createAssembly](fileIDs2, uploadID, options);
              if (this.opts.importFromUploadURLs) {
                await _classPrivateFieldLooseBase16(this, _reserveFiles)[_reserveFiles](assembly, fileIDs2);
              }
          ...
          return assemblyOptions.build().then((assemblies) => Promise.all(assemblies.map(createAssembly))).then((maybeCreatedAssemblies) => {
            ...
            _classPrivateFieldLooseBase16(this, _createAssemblyWatcher)[_createAssemblyWatcher](assemblyIDs, uploadID);
            return Promise.all(createdAssemblies.map((assembly) => _classPrivateFieldLooseBase16(this, _connectAssembly)[_connectAssembly](assembly)));
          }).catch((err) => {
        ...
        value: (fileIDs, uploadID) => {
          ...
          if (this.restored) {
            return this.restored.then(() => {
              return _classPrivateFieldLooseBase16(this, _afterUpload)[_afterUpload](filteredFileIDs, uploadID);
            });
          }
          ...
          if (!_classPrivateFieldLooseBase16(this, _shouldWaitAfterUpload)[_shouldWaitAfterUpload]()) {
            closeSocketConnections();
            const assemblies = assemblyIDs.map((id19) => this.getAssembly(id19));
      ...
      Object.defineProperty(this, _onError3, {
        ...
        value: function(err, uploadID) {
          ...
          const assemblyIDs = state.uploadsAssemblies[uploadID];
          assemblyIDs == null ? void 0 : assemblyIDs.forEach(_classPrivateFieldLooseBase16(_this, _closeAssemblyIfExists)[_closeAssemblyIfExists]);
      ...
      Object.defineProperty(this, _onTusError, {
        ...
        value: (file, err) => {
          ...
          _classPrivateFieldLooseBase16(this, _closeAssemblyIfExists)[_closeAssemblyIfExists](file == null ? void 0 : (_file$transloadit2 = file.transloadit) == null ? void 0 : _file$transloadit2.assembly);
      ...
      _classPrivateFieldLooseBase16(this, _rateLimitedQueue2)[_rateLimitedQueue2] = new RateLimitedQueue(this.opts.limit);
      this.i18nInit();
      ...
      this.client = new Client({
        ...
        client: _classPrivateFieldLooseBase16(this, _getClientVersion)[_getClientVersion](),
        errorReporting: this.opts.errorReporting,
        rateLimitedQueue: _classPrivateFieldLooseBase16(this, _rateLimitedQueue2)[_rateLimitedQueue2]
      });
    ...
    install() {
      this.uppy.addPreProcessor(_classPrivateFieldLooseBase16(this, _prepareUpload)[_prepareUpload]);
      this.uppy.addPostProcessor(_classPrivateFieldLooseBase16(this, _afterUpload)[_afterUpload]);
      this.uppy.on("error", _classPrivateFieldLooseBase16(this, _onError3)[_onError3]);
      this.uppy.on("cancel-all", _classPrivateFieldLooseBase16(this, _onCancelAll)[_onCancelAll]);
      this.uppy.on("upload-error", _classPrivateFieldLooseBase16(this, _onTusError)[_onTusError]);
      if (this.opts.importFromUploadURLs) {
        this.uppy.on("upload-success", _classPrivateFieldLooseBase16(this, _onFileUploadURLAvailable)[_onFileUploadURLAvailable]);
      } else {
        this.uppy.use(Tus, {
          storeFingerprintForResuming: false,
      ...
      this.uppy.on("restore:get-data", _classPrivateFieldLooseBase16(this, _getPersistentData)[_getPersistentData]);
      this.uppy.on("restored", _classPrivateFieldLooseBase16(this, _onRestored)[_onRestored]);
      this.setPluginState({
        assemblies: {},
        uploadsAssemblies: {},
        files: {},
    ...
    uninstall() {
      this.uppy.removePreProcessor(_classPrivateFieldLooseBase16(this, _prepareUpload)[_prepareUpload]);
      this.uppy.removePostProcessor(_classPrivateFieldLooseBase16(this, _afterUpload)[_afterUpload]);
      this.uppy.off("error", _classPrivateFieldLooseBase16(this, _onError3)[_onError3]);
      if (this.opts.importFromUploadURLs) {
        this.uppy.off("upload-success", _classPrivateFieldLooseBase16(this, _onFileUploadURLAvailable)[_onFileUploadURLAvailable]);
      }
      const {
        capabilities
      } = this.uppy.getState();
  ...
  function _createAssembly2(fileIDs, uploadID, options) {
    ...
    return this.client.createAssembly({
      ...
      const assembly = new Assembly_default(newAssembly, _classPrivateFieldLooseBase16(this, _rateLimitedQueue2)[_rateLimitedQueue2]);
      const {
        status
      } = assembly;
      ...
      const updatedFiles = {};
      files.forEach((file) => {
        updatedFiles[file.id] = _classPrivateFieldLooseBase16(this, _attachAssemblyMetadata)[_attachAssemblyMetadata](file, status);
      });
      this.uppy.setState({
        files: {
          ...this.uppy.getState().files,
      ...
      const fileRemovedHandler = (fileRemoved, reason) => {
        if (reason === "cancel-all") {
          ...
          if (nbOfRemainingFiles === 0) {
            assembly.close();
            _classPrivateFieldLooseBase16(this, _cancelAssembly)[_cancelAssembly](newAssembly).catch(() => {
            });
            this.uppy.off(fileRemovedHandler);
          } else {
  ...
  function _createAssemblyWatcher2(assemblyID, uploadID) {
    ...
    watcher.on("assembly-complete", (id19) => {
      const files = this.getAssemblyFiles(id19);
      files.forEach((file) => {
        this.completedFiles[file.id] = true;
        this.uppy.emit("postprocess-complete", file);
      });
    });
    watcher.on("assembly-error", (id19, error) => {
      const files = this.getAssemblyFiles(id19);
      files.forEach((file) => {
        this.uppy.emit("upload-error", file, error);
        this.uppy.emit("postprocess-complete", file);
  ...
  function _connectAssembly2(assembly) {
    ...
    const id19 = status.assembly_id;
    this.activeAssemblies[id19] = assembly;
    ...
    assembly.on("upload", (file) => {
      _classPrivateFieldLooseBase16(this, _onFileUploadComplete)[_onFileUploadComplete](id19, file);
    });
    ...
    if (this.opts.waitForEncoding) {
      assembly.on("result", (stepName, result) => {
        _classPrivateFieldLooseBase16(this, _onResult)[_onResult](id19, stepName, result);
      });
    }
    if (this.opts.waitForEncoding) {
      assembly.on("finished", () => {
        _classPrivateFieldLooseBase16(this, _onAssemblyFinished)[_onAssemblyFinished](assembly.status);
      });
  ...
  var _updateFilesAndFolders = /* @__PURE__ */ _classPrivateFieldLooseKey17("updateFilesAndFolders");
  var ProviderView = class extends View {
    ...
    getFolder(id19, name) {
      return this.sharedHandler.loaderWrapper(this.provider.list(id19), (res) => {
        const folders = [];
        const files = [];
        let updatedDirectories;
        const state = this.plugin.getPluginState();
        const index = state.directories.findIndex((dir) => id19 === dir.id);
        if (index !== -1) {
        ...
        _classPrivateFieldLooseBase17(this, _updateFilesAndFolders)[_updateFilesAndFolders](res, files, folders);
        this.plugin.setPluginState({
    ...
    addFolder(folder) {
      ...
      return this.listAllFiles(folder.requestPath).then((files) => {
        let count = 0;
        files.forEach((file) => {
          const id19 = this.providerFileToId(file);
          if (!this.plugin.uppy.checkIfFileAlreadyExists(id19)) {
            count++;
          }
        });
        if (count > 0) {
    ...
    async handleScroll(event) {
      ...
      if (this.shouldHandleScroll(event) && path) {
        ...
        try {
          ...
          _classPrivateFieldLooseBase17(this, _updateFilesAndFolders)[_updateFilesAndFolders](response, files, folders);
        } catch (error) {
  ...
  var _updateFilesAndInputMode = /* @__PURE__ */ _classPrivateFieldLooseKey18("updateFilesAndInputMode");
  var SearchProviderView = class extends View {
    ...
    search(query) {
      ...
      return this.sharedHandler.loaderWrapper(this.provider.search(query), (res) => {
        _classPrivateFieldLooseBase18(this, _updateFilesAndInputMode)[_updateFilesAndInputMode](res, []);
      }, this.handleError);
    }
    triggerSearchInput() {
      this.plugin.setPluginState({
    ...
    async handleScroll(event) {
      ...
      if (this.shouldHandleScroll(event) && query) {
        ...
        try {
          ...
          _classPrivateFieldLooseBase18(this, _updateFilesAndInputMode)[_updateFilesAndInputMode](response, files);
        } catch (error) {
          this.handleError(error);
        } finally {
          this.isHandlingScroll = false;
